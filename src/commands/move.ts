...
registerCommand(Command.upPage      , CommandFlags.ChangeSelections, (_, { repetitions }) => scrollBy(repetitions,   'up', 'page'))
registerCommand(Command.upHalfPage  , CommandFlags.ChangeSelections, (_, { repetitions }) => scrollBy(repetitions,   'up', 'halfPage'))
registerCommand(Command.downPage    , CommandFlags.ChangeSelections, (_, { repetitions }) => scrollBy(repetitions, 'down', 'page'))
registerCommand(Command.downHalfPage, CommandFlags.ChangeSelections, (_, { repetitions }) => scrollBy(repetitions, 'down', 'halfPage'))
